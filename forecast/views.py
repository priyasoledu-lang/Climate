...
def prepare_data(data):
    ...
    data['WindGustDir']=wind_encoder.fit_transform(data['WindGustDir'])
    data['RainTomorrow']=rain_encoder.fit_transform(data['RainTomorrow'])

#define the feature variable and target 
    X=data[['MinTemp','MaxTemp','WindGustDir','WindGustSpeed','Humidity','Pressure','Temp']] #feature variables
    y=data['RainTomorrow'] #target variables
    return X,y,wind_encoder,rain_encoder #return target variable,feature variable
...
def prepare_regression_data(data,feature):
    X,y=[],[] #intialise list of feature and target values
...
#   compass_direction_encoded=le.transform([compass_direction])[0] if compass_direction in le.classes_ else -1
       compass_direction_encoded = (
            wind_encoder.transform([compass_direction])[0]
            if compass_direction in wind_encoder.classes_ else -1)
       current_data={
